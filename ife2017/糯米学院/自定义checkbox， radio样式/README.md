...
1. MDN background-position: 了解背景图片定位相关知识
1. MDN :checked: 了解input的:checked伪类的基本知识以及应用场景
1. MDN :before:了解input的:before伪元素的基本知识
1. MDN :after:了解input的:after伪元素的基本知识
